...
class Convert extends AbstractHelper
{
    ...
    public function to($calendar)
    {
        ...
        $date = new DateTime(null, $calendar, $this->date->getLocale());
        $date->setTimeZone($this->date->getTimeZone());
        $date->setTimestamp($this->date->getTimestamp());
     ...
     * @return array
     */
    public function toList($calendar)
    {
        $result = array();
